namespace BatchGuy.App.Constants
{
  public static class Constant
  {
      ...
      public const string FeatureCreateEac3toBatchFileFormMKVMergeOutputDirectory = "create-eac3to-batch-file-form-mkvmerge-output-directory";
        public const string FeatureCreateEac3toBatchFileFormSaveMKVMergeBatchFileDirectory = "create-eac3to-batch-file-form-save-mkvmerge-batch-file-directory";
    }
}
